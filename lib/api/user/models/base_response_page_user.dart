...
FutureOr<BaseResponsePageUser> deserializeBaseResponsePageUser(Map<String, dynamic> json) =>
    BaseResponsePageUser.fromJson(json);

FutureOr<List<BaseResponsePageUser>> deserializeBaseResponsePageUserList(List<Map<String, dynamic>> json) =>
    json.map((e) => BaseResponsePageUser.fromJson(e)).toList();

FutureOr<Map<String, dynamic>> serializeBaseResponsePageUser(BaseResponsePageUser? object) =>
    object?.toJson() ?? <String, dynamic>{};

FutureOr<List<Map<String, dynamic>>> serializeBaseResponsePageUserList(List<BaseResponsePageUser>? objects) =>
