...
FutureOr<NotificationBatchReadRequest> deserializeNotificationBatchReadRequest(Map<String, dynamic> json) =>
    NotificationBatchReadRequest.fromJson(json);

FutureOr<List<NotificationBatchReadRequest>> deserializeNotificationBatchReadRequestList(List<Map<String, dynamic>> json) =>
    json.map((e) => NotificationBatchReadRequest.fromJson(e)).toList();

FutureOr<Map<String, dynamic>> serializeNotificationBatchReadRequest(NotificationBatchReadRequest? object) =>
    object?.toJson() ?? <String, dynamic>{};

FutureOr<List<Map<String, dynamic>>> serializeNotificationBatchReadRequestList(List<NotificationBatchReadRequest>? objects) =>
