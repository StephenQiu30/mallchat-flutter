...
part of 'page_notification_vo.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PageNotificationVo _$PageNotificationVoFromJson(
  Map json,
) => $checkedCreate('PageNotificationVo', json, ($checkedConvert) {
  final val = PageNotificationVo(
    records: $checkedConvert(
      'records',
      (v) => (v as List<dynamic>?)
          ?.map(
            (e) => NotificationVo.fromJson(Map<String, Object?>.from(e as Map)),
          )
          .toList(),
    ),
...
Map<String, dynamic> _$PageNotificationVoToJson(PageNotificationVo instance) =>
    <String, dynamic>{
