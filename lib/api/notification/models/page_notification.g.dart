...
PageNotification _$PageNotificationFromJson(Map json) =>
    $checkedCreate('PageNotification', json, ($checkedConvert) {
      final val = PageNotification(
        records: $checkedConvert(
          'records',
          (v) => (v as List<dynamic>?)
              ?.map(
                (e) =>
                    Notification.fromJson(Map<String, Object?>.from(e as Map)),
              )
              .toList(),
        ),
