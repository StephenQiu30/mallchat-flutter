...
FutureOr<NotificationReadRequest> deserializeNotificationReadRequest(Map<String, dynamic> json) =>
    NotificationReadRequest.fromJson(json);

FutureOr<List<NotificationReadRequest>> deserializeNotificationReadRequestList(List<Map<String, dynamic>> json) =>
    json.map((e) => NotificationReadRequest.fromJson(e)).toList();

FutureOr<Map<String, dynamic>> serializeNotificationReadRequest(NotificationReadRequest? object) =>
    object?.toJson() ?? <String, dynamic>{};

FutureOr<List<Map<String, dynamic>>> serializeNotificationReadRequestList(List<NotificationReadRequest>? objects) =>
