...
FutureOr<FileUploadRequestBody> deserializeFileUploadRequestBody(Map<String, dynamic> json) =>
    FileUploadRequestBody.fromJson(json);

FutureOr<List<FileUploadRequestBody>> deserializeFileUploadRequestBodyList(List<Map<String, dynamic>> json) =>
    json.map((e) => FileUploadRequestBody.fromJson(e)).toList();

FutureOr<Map<String, dynamic>> serializeFileUploadRequestBody(FileUploadRequestBody? object) =>
    object?.toJson() ?? <String, dynamic>{};

FutureOr<List<Map<String, dynamic>>> serializeFileUploadRequestBodyList(List<FileUploadRequestBody>? objects) =>
