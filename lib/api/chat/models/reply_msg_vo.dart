...
@JsonSerializable()
class ReplyMsgVo {
  const ReplyMsgVo({this.id, this.userName, this.content, this.type});

  factory ReplyMsgVo.fromJson(Map<String, Object?> json) =>
      _$ReplyMsgVoFromJson(json);
...
FutureOr<List<ReplyMsgVo>> deserializeReplyMsgVoList(
...
FutureOr<List<Map<String, dynamic>>> serializeReplyMsgVoList(
  List<ReplyMsgVo>? objects,
