...
FutureOr<BaseResponseLong> deserializeBaseResponseLong(Map<String, dynamic> json) =>
    BaseResponseLong.fromJson(json);

FutureOr<List<BaseResponseLong>> deserializeBaseResponseLongList(List<Map<String, dynamic>> json) =>
    json.map((e) => BaseResponseLong.fromJson(e)).toList();

FutureOr<Map<String, dynamic>> serializeBaseResponseLong(BaseResponseLong? object) =>
    object?.toJson() ?? <String, dynamic>{};

FutureOr<List<Map<String, dynamic>>> serializeBaseResponseLongList(List<BaseResponseLong>? objects) =>
