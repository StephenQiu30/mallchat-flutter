...
PageOperationLogVo _$PageOperationLogVoFromJson(
  Map json,
) => $checkedCreate('PageOperationLogVo', json, ($checkedConvert) {
  final val = PageOperationLogVo(
    records: $checkedConvert(
      'records',
      (v) => (v as List<dynamic>?)
          ?.map(
            (e) => OperationLogVo.fromJson(Map<String, Object?>.from(e as Map)),
          )
          .toList(),
    ),
