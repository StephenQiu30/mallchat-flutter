...
PageUserLoginLogVo _$PageUserLoginLogVoFromJson(
  Map json,
) => $checkedCreate('PageUserLoginLogVo', json, ($checkedConvert) {
  final val = PageUserLoginLogVo(
    records: $checkedConvert(
      'records',
      (v) => (v as List<dynamic>?)
          ?.map(
            (e) => UserLoginLogVo.fromJson(Map<String, Object?>.from(e as Map)),
          )
          .toList(),
    ),
