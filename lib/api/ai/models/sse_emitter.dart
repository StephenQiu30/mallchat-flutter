...
class SseEmitter {
  ...
  factory SseEmitter.fromJson(Map<String, Object?> json) =>
...
FutureOr<List<SseEmitter>> deserializeSseEmitterList(
...
FutureOr<List<Map<String, dynamic>>> serializeSseEmitterList(
  List<SseEmitter>? objects,
