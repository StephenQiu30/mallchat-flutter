...
@JsonSerializable()
class AiModelVo {
  const AiModelVo({this.name, this.description});

  factory AiModelVo.fromJson(Map<String, Object?> json) =>
      _$AiModelVoFromJson(json);
...
FutureOr<List<AiModelVo>> deserializeAiModelVoList(
...
FutureOr<List<Map<String, dynamic>>> serializeAiModelVoList(
  List<AiModelVo>? objects,
