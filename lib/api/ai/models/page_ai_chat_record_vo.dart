...
FutureOr<PageAiChatRecordVo> deserializePageAiChatRecordVo(Map<String, dynamic> json) =>
    PageAiChatRecordVo.fromJson(json);

FutureOr<List<PageAiChatRecordVo>> deserializePageAiChatRecordVoList(List<Map<String, dynamic>> json) =>
    json.map((e) => PageAiChatRecordVo.fromJson(e)).toList();

FutureOr<Map<String, dynamic>> serializePageAiChatRecordVo(PageAiChatRecordVo? object) =>
    object?.toJson() ?? <String, dynamic>{};

FutureOr<List<Map<String, dynamic>>> serializePageAiChatRecordVoList(List<PageAiChatRecordVo>? objects) =>
