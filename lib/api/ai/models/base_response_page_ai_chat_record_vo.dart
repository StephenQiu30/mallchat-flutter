...
FutureOr<BaseResponsePageAiChatRecordVo> deserializeBaseResponsePageAiChatRecordVo(Map<String, dynamic> json) =>
    BaseResponsePageAiChatRecordVo.fromJson(json);

FutureOr<List<BaseResponsePageAiChatRecordVo>> deserializeBaseResponsePageAiChatRecordVoList(List<Map<String, dynamic>> json) =>
    json.map((e) => BaseResponsePageAiChatRecordVo.fromJson(e)).toList();

FutureOr<Map<String, dynamic>> serializeBaseResponsePageAiChatRecordVo(BaseResponsePageAiChatRecordVo? object) =>
    object?.toJson() ?? <String, dynamic>{};

FutureOr<List<Map<String, dynamic>>> serializeBaseResponsePageAiChatRecordVoList(List<BaseResponsePageAiChatRecordVo>? objects) =>
