...
part of 'page_ai_chat_record_vo.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PageAiChatRecordVo _$PageAiChatRecordVoFromJson(
  Map json,
) => $checkedCreate('PageAiChatRecordVo', json, ($checkedConvert) {
  final val = PageAiChatRecordVo(
    records: $checkedConvert(
      'records',
      (v) => (v as List<dynamic>?)
          ?.map(
            (e) => AiChatRecordVo.fromJson(Map<String, Object?>.from(e as Map)),
          )
          .toList(),
    ),
...
Map<String, dynamic> _$PageAiChatRecordVoToJson(PageAiChatRecordVo instance) =>
    <String, dynamic>{
