...
PageAiChatRecordVo _$PageAiChatRecordVoFromJson(Map<String, dynamic> json) =>
    PageAiChatRecordVo(
      records: (json['records'] as List<dynamic>?)
          ?.map((e) => AiChatRecordVo.fromJson(e as Map<String, dynamic>))
          .toList(),
