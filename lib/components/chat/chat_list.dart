...
class ChatList extends StatelessWidget {
          ...
          child: ListView(
            ...
            children: [
              _buildChatCell(
                ...
                avatarUrl:
                    "https://api.dicebear.com/7.x/identicon/svg?seed=mallchat&backgroundColor=c0aede",
                isActive: true,
              ),
              _buildChatCell(
                name: "Alice (架构师)",
              ...
              _buildChatCell(
                ...
                msg: "Nacos 配置已经同步了。",
                avatarUrl:
                    "https://api.dicebear.com/7.x/notionists/svg?seed=Bob&backgroundColor=a7f3d0",
              ),
            ],
          ),
        ),
  ...
  Widget _buildChatCell({
    ...
    return Container(
      color: isActive
          ? const Color(0xFF0052D9).withValues(alpha: 0.08)
          : Colors.transparent,
      ...
      child: Row(
        children: [
          ...
          Stack(
            children: [
              MallChatAvatar(size: TDAvatarSize.large, avatarUrl: avatarUrl),
              if (unread)
                Positioned(
                  top: 0,
                  right: 0,
